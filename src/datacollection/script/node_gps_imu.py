...
class ExtrinsicIntrinsic(DataGenerator):
    ...
    def camera_gps_imu_callback(self, gps_data_global, gps_data_local, imu_data, compass_hdg):
        self.latitude = gps_data_global.latitude
        self.longitude = gps_data_global.longitude
        self.altitude = gps_data_global.altitude
        rospy.loginfo("Latitude: {}, Longitude: {}, Altitude: {}".format(self.latitude, self.longitude, self.altitude))
        
        self.quaternion = (
            gps_data_local.pose.orientation.x, 
            gps_data_local.pose.orientation.y, 
            gps_data_local.pose.orientation.z,
            gps_data_local.pose.orientation.w,
        )
        ...
        # rospy.loginfo("Roll: {}, Pitch: {}, Yaw: {}".format(self.roll, self.pitch, self.yaw))
